...
import com.findtech.threePomelos.view.calendar.format.ArrayWeekDayFormatter;
import com.findtech.threePomelos.view.calendar.format.DateFormatTitleFormatter;
import com.findtech.threePomelos.view.calendar.format.DayFormatter;
import com.findtech.threePomelos.view.calendar.format.MonthArrayTitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    private AbstractCalendarPagerAdapter<?> adapter;
    ...
    private CalendarBtnListener btnListener;
    ...
    private final ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (btnListener != null){
                btnListener.selectMonth(currentMonth);
            }
            updateUi();
    ...
    public void setBtnListener(CalendarBtnListener btnListener) {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        if (isInEditMode()) {
            ...
            LayoutParams layoutParams = new LayoutParams(calendarMode.visibleWeeksCount + DAY_NAMES_ROW);
    ...
    /**
     * Go to previous month or week without using the button {@link }. Should only go to
    ...
    /**
     * Go to next month or week without using the button {@link }. Should only go to
...
//    }
    ...
    /**
     * Call by {@link AbstractCalendarPagerView} to indicate that a day was clicked and we should handle it.
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        int measuredHeight = (int) ((measureTileHeight * 0.8) * viewTileHeight);
    ...
    protected static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(int titleWidth, int tileHeight) {
            super(titleWidth, tileHeight);
        }
    ...
    private void commit(State state) {
        ...
        if (adapter != null && state.cacheCurrentPosition) {
            ...
            if (calendarMode != state.calendarMode) {
                ...
                if (calendarMode == CalendarMode.MONTHS && currentlySelectedDate != null) {
                    ...
                    boolean b = (currentlySelectedDate.isAfter(calendarDayToShow) && currentlySelectedDate.isBefore(lastVisibleCalendarDay));
                    if (currentlySelectedDate.equals(calendarDayToShow) || b ) {
        ...
        // Recreate adapter
        final AbstractCalendarPagerAdapter<?> newAdapter;
        switch (calendarMode) {
            case MONTHS:
    ...
    public void setDatesListSelected(ArrayList<CalendarDay> calendarDayArrayList) {
        adapter.setDatesSelected(calendarDayArrayList);
    }

    public void setDataSelectReturn(CalendarDay calendarDay){
        clearSelection();
        adapter.setDateSelected(calendarDay,true);
        adapter.invalidateDecorators();
    }
}
