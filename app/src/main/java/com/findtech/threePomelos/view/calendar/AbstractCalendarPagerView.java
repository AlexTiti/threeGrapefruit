...
import static com.findtech.threePomelos.view.calendar.MaterialCalendarView.SHOW_DEFAULTS;
import static com.findtech.threePomelos.view.calendar.MaterialCalendarView.showOtherMonths;
import static java.util.Calendar.DATE;

abstract class AbstractCalendarPagerView extends ViewGroup implements View.OnClickListener {
    /**
     * 一周天数
     */
    ...
    private static final Calendar TEMP_WORKING_CALENDAR = CalendarUtils.getInstance();
    ...
    public AbstractCalendarPagerView(@NonNull MaterialCalendarView view,
    ...
    protected Calendar resetAndGetWorkingCalendar() {
        getFirstViewDay().copyTo(TEMP_WORKING_CALENDAR);
        //noinspection ResourceType
        TEMP_WORKING_CALENDAR.setFirstDayOfWeek(getFirstDayOfWeek());
        int dow = CalendarUtils.getDayOfWeek(TEMP_WORKING_CALENDAR);
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(AbstractCalendarPagerView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(AbstractCalendarPagerView.class.getName());
    }
