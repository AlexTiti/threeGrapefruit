...
public class BannerView<T> extends RelativeLayout {
     ...
     */
    private int[] mIndicatorRes = new int[]{R.drawable.unselected, R.drawable.travel_selected};
    ...
    private int indicatorMarginLeft = 20;
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        indicatorRadius = typedArray.getDimensionPixelSize(R.styleable.BannerView_indicatorRadius, 10);
        indicatorMarginLeft = typedArray.getDimensionPixelSize(R.styleable.BannerView_indicatorMarginLeft, 20);
        typedArray.recycle();
    }
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            if (mIndicatorAlign == IndicatorAlign.LEFT.ordinal()) {
                ...
                if (i == mDatas.size() - 1) {
                    ...
                    imageView.setPadding(20, 0, 20 + paddingRight, 0);
                } else {
                    imageView.setPadding(20, 0, 20, 0);
                }

            } else {
                imageView.setPadding(indicatorMarginLeft, 0, indicatorMarginLeft, 0);
            }
