...
public class DatepickerDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wvBlankLeft = findViewById(R.id.blank0);
        wvBlankRight = findViewById(R.id.blank1);
    ...
    public void onClick(View v) {
        ...
        if (v == btnSure) {
            if (onBirthListener != null) {
                boolean year = (Integer.parseInt(selectYear) >= getYear()) && (Integer.parseInt(selectMonth) > getMonth());
                boolean month = (Integer.parseInt(selectMonth) == getMonth() && Integer.parseInt(selectDay) > getDay());
