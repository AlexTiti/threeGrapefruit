...
import static com.findtech.threePomelos.view.calendar.MaterialCalendarView.showDecoratedDisabled;
import static com.findtech.threePomelos.view.calendar.MaterialCalendarView.showOtherMonths;
import static com.findtech.threePomelos.view.calendar.MaterialCalendarView.showOutOfRange;
...
class DayView extends android.support.v7.widget.AppCompatCheckedTextView {
    ...
    /**
     * 返会DayFormatter对象中储存日期的格式化对象 DateFormat
     */
    ...
    void applyFacade(DayViewFacade facade) {
        ...
        if (!spans.isEmpty()) {
            ...
            for (DayViewFacade.Span span : spans) {
                formattedLabel.setSpan(span.span, 0, label.length(), Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
            }
