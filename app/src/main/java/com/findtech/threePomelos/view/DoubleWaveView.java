...
public class DoubleWaveView extends View {
    ...
    public DoubleWaveView(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.DoubleWaveView_peakValue) {
                //振幅默认是30dp
                ...
                WAVE_PAINT_COLOR = a.getColor(attr, 0xc75564);
                //默认是白色

            } else if (attr == R.styleable.DoubleWaveView_waveColorTow) {
                WAVE_PAINT_COLOR_TOW = a.getColor(attr, 0xFFFFFF);
                //默认是粉色
