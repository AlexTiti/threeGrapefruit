 ...
 */
package com.findtech.threePomelos.view.datepicker.wheel.widget.adapters;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	private static int midlesize = 18;
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource) {
		this(context, itemResource, NO_RESOURCE, 0, maxsize, midlesize, minsize);
	}
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
			int maxsize,int midlesize, int minsize) {
		this.context = context;
		itemResourceId = itemResource;
		itemTextResourceId = itemTextResource;
		this.currentIndex = currentIndex;
		AbstractWheelTextAdapter.maxsize = maxsize;
		AbstractWheelTextAdapter.midlesize = midlesize;
	...
	public View getItem(int index, View convertView, ViewGroup parent) {
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				}else if( Math.abs(index - currentIndex)==1|| Math.abs(index - currentIndex)+1 == getItemsCount()) {
					textView.setTextSize(midlesize);
