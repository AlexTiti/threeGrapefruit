 ...
 */
abstract class AbstractCalendarPagerAdapter<V extends AbstractCalendarPagerView> extends PagerAdapter {
    ...
    AbstractCalendarPagerAdapter(MaterialCalendarView mcv) {
        this.mcv = mcv;
    ...
    public AbstractCalendarPagerAdapter<?> migrateStateAndReturn(AbstractCalendarPagerAdapter<?> newAdapter) {
    ...
    public int getItemPosition(Object object) {
        ...
        AbstractCalendarPagerView pagerView = (AbstractCalendarPagerView) object;
    ...
    public void setDatesSelected(ArrayList<CalendarDay> calendarDays) {
    ...
    private void validateSelectedDates() {
        for (int i = 0; i < selectedDates.size(); i++) {
            ...
            boolean max = (maxDate != null && maxDate.isBefore(date));
            boolean min = (minDate != null && minDate.isAfter(date));
            if (min || max) {
