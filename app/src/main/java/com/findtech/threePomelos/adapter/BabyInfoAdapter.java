...
public class BabyInfoAdapter extends RecyclerView.Adapter<BabyInfoAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            babyInfoTitle = itemView.findViewById(R.id.baby_info_title);
            babyInfo = itemView.findViewById(R.id.baby_info);
            arrowRight = itemView.findViewById(R.id.arrow_right_icon);
