...
public class MusicAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.text_number = convertView.findViewById(R.id.text_number);
            viewHolder.imageView = convertView.findViewById(R.id.image_sound);
            viewHolder.image_down = convertView.findViewById(R.id.image_down);
