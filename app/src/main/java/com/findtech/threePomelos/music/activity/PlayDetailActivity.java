 ...
 */
public class PlayDetailActivity extends BaseCompatActivity implements View.OnClickListener , BaseCompatActivity.MusicInterface {
    ...
    private ImageView img_round_detail;
    ...
    private void init() {
        ...
        imageView_control = findViewById(R.id.image_control);
        imageView_next = findViewById(R.id.image_next);
        imageView_prev = findViewById(R.id.image_prev);
        textView_music = findViewById(R.id.music_name);
        playerSeekBar = findViewById(R.id.play_seek);
        mTimePlayed = findViewById(R.id.time_play);
        mDuration = findViewById(R.id.mduration);
        play_mode = findViewById(R.id.play_mode);
        image_collection = findViewById(R.id.image_collection);
        image_download = findViewById(R.id.image_down);
        img_round_detail = findViewById(R.id.img_round_detail);
        music_link_layout = findViewById(R.id.music_link_layout);
        ...
        seekBarVoice = findViewById(R.id.voice_seekbar);
    ...
    private void setVoiceSeekBar() {
        ...
        currentVoice = mAudiomanger.getStreamVolume(AudioManager.STREAM_MUSIC);
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        Rela_round_play = findViewById(R.id.Rela_round_play);
        img_down = findViewById(R.id.img_down);
        animatorWeakReference = new WeakReference(ObjectAnimator.ofFloat(Rela_round_play, "rotation", 0.0F, 360.0F));
    ...
    public void updateTrack() {
        ...
        HashMap<Long, MusicInfo> hashMap = MusicPlayer.getPlayinfos();
        if (hashMap != null) {
            MusicInfo mode = hashMap.get(MusicPlayer.getCurrentAudioId());
        ...
        private void upImageView(MusicInfo info ){
            if ( info != null && info.faceImage != null){
              Glide.with(PlayDetailActivity.this).load(info.faceImage).apply(RequestOptions.errorOf(R.drawable.face_music_car_a)).into(img_round_detail);
            }
