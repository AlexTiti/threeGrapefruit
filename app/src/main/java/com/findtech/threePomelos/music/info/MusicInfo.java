...
public class MusicInfo implements Parcelable {
    ...
    public static final Creator<MusicInfo> CREATOR = new Creator<MusicInfo>() {
        ...
        public MusicInfo createFromParcel(Parcel source) {
            ...
            music.type = (Number) bundle.getSerializable(KEY_TYPE);
            music.avObject = bundle.getString(KEY_FILE);
            music.avObject = bundle.getString(KEY_TYPE_NAME);
            music.avObject = bundle.getString(KEY_FACE_IMAGE);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        bundle.putString(KEY_FILE,avObject);
        bundle.putString(KEY_TYPE_NAME,avObject);
        bundle.putString(KEY_FACE_IMAGE,avObject);
