 ...
 */
public class RepairActivity extends BaseCompatActivity implements BLEDevice.RFStarBLEBroadcastReceiver {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        text_state_repair = findViewById(R.id.text_state_repair);
