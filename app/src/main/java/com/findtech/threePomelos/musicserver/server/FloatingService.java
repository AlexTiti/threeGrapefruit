package com.findtech.threePomelos.musicserver.server;
...
public class FloatingService extends Service {
    ...
    private void initWindow() {
        ...
        screenWidth = Objects.requireNonNull(mWindowManager).getDefaultDisplay().getWidth();
    ...
    private void initFloating() {
        doubleWaveView = mlayout.findViewById(R.id.waveView);
