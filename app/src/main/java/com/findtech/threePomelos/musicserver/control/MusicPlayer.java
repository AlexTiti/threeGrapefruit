...
public class MusicPlayer {
    ...
    private static final WeakHashMap<Context, ServiceBinder> WEAK_HASH_MAP;
    private static final long[] S_EMPTY_LIST;
    public static MediaAidlInterface mService = null;
    private static ContentValues[] mContentValuesCache = null;

    static {
        WEAK_HASH_MAP = new WeakHashMap<Context, ServiceBinder>();
        S_EMPTY_LIST = new long[0];
    }
    ...
    public static final ServiceToken bindToService(final Context context,
        ...
        if (contextWrapper.bindService(
            ...
            WEAK_HASH_MAP.put(contextWrapper, binder);
    ...
    public static void unbindFromService(final ServiceToken token) {
        ...
        final ServiceBinder mBinder = WEAK_HASH_MAP.remove(mContextWrapper);
        if (mBinder == null) {
            return;
        }
        mContextWrapper.unbindService(mBinder);
        if (WEAK_HASH_MAP.isEmpty()) {
            mService = null;
        }
    }
